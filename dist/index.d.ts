...
declare const qdrantPlugin: {
    ...
    description: string;
    adapters: {
        init: (runtime: _elizaos_core.IAgentRuntime) => _elizaos_core.IDatabaseAdapter & _elizaos_core.IDatabaseCacheAdapter;
    }[];
};

export { QdrantDatabaseAdapter, qdrantPlugin as default };
